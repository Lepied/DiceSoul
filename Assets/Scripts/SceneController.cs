...
public class SceneController : MonoBehaviour
{
    ...
    private IEnumerator TransitionToScene(string sceneName, System.Action callback)
    {
        ...
        // BGM 페이드 인 (새 씬의 BGM이 재생된 후 볼륨을 페이드 인)
        if (SoundManager.Instance != null && SoundManager.Instance.bgmSource != null && SoundManager.Instance.bgmSource.isPlaying)
        {
            SoundManager.Instance.FadeBGMIn(fadeDuration * 0.5f, SoundManager.Instance.bgmSource.volume);
        }
